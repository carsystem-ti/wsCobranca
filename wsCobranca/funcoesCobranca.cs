...
namespace wsCobranca
{
    public class funcoesCobranca
    {
        ...
        private readonly string codigoCobradora = "009528";
        ...
        public string setRenovaCliente(string nContrato, double vlRenova, double vlTaxa, double vlGuincho, string nrAut, int nrPC, string cdBanco, string nrCob, System.Data.SqlClient.SqlTransaction pTransacao)
        {
            try
            {
                System.Web.Script.Serialization.JavaScriptSerializer jsonSerialiser = new System.Web.Script.Serialization.JavaScriptSerializer();
